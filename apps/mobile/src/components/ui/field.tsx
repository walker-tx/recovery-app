...
export function TextField({
  ...
  return (
    ...
    >
      <View
        className={`min-h-touch flex-row items-stretch overflow-hidden rounded-subtle border bg-surface ${borderClassName}`}
      >
        <TextInput
        ...
        />
        {endAdornment ? (
          <View className="justify-center">{endAdornment}</View>
        ) : null}
      </View>
    </Field>
  );
