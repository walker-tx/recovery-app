...
Read `docs/architecture.md` before adding a feature, moving code across boundaries, introducing shared state, adopting a structural library, or creating a reusable abstraction. Treat its invariants as mandatory and its defaults as the starting point.
